...
public class Setting {
	...
	public final static String[] PerfCounters = { "cpu.usage.average", "cpu.usagemhz.average",
		"mem.usage.average", "disk.usage.average", "disk.read.average", "disk.write.average",
